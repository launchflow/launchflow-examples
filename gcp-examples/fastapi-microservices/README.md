...
This example shows you how to build modern FastAPI microservices with LaunchFlow. Here we have two services:

- `service1`
- `service2`

each with their own directory and Dockerfile. To setup a monorepo we simply reference both of them in our `launchflow.yaml`, and launchflow will automatically build and deploy both services.
